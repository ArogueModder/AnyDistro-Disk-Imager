...
# ============================================================================
# Step 4: Create application wrapper script
# ============================================================================

echo "=== Step 4: Creating application wrapper ==="
...
site_packages = os.path.join(appdir, 'usr', 'lib', 'python3.6', 'site-packages')
sys.path.insert(0, site_packages)

# Import and run the application
from anydistro_disk_imager.__main__ import main
main()
EOF
...
if [ -f "$SCRIPT_DIR/DiskImager.png" ]; then
...
exec "${APPDIR}/usr/bin/python" -m anydistro_disk_imager.__main__ "$@"
EOF
...
APPIMAGE_NAME="${PROJECT_NAME}-${ARCH}.AppImage"
APPIMAGE_SOURCE="$BUILD_DIR/${PROJECT_NAME}-${ARCH}.AppImage"
